...
<body>
		...
		<div class="headercss">
			<form id="search_form" action="" method="post">
				<fieldset class="form_fieldset">
					...
					<br>
					<div class="searchdiv" style="margin-top: -5px; margin-right: 400px">
	...
	<div id="editpoint" closed="true" class="easyui-window">
		<form id="editFormpoint" enctype="multipart/form-data" method="post">
			...
			<input type="hidden" name="proxyTeacher.id" id="edit_proxyteacherid">
		</form>
	</div>
	...
	<div id="xiangqing_win" class="easyui-window" closed="true">
		<form id="xiangqingFrom" action="">
			...
			<div class="row"
				...
				<div class="col-md-3" style="margin-left: 53px">
					<label>数据来源：</label><input type="text" id="sources" name="source.id"
						style="border: none;" readonly="readonly">
				</div>
				...
				<div class="col-md-3" style="margin-left: 53px">
					...
					<div
						...
						<textarea rows="5" cols="22" name="remark" id="sremark"
					...
					<div class="col-md-3" style="margin-left: -42px">
						...
						<div
							...
							<img alt="图片" style="width: 100%; height: 120px;" id="sbankcard"
