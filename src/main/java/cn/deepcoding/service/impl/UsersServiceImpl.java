...
public class UsersServiceImpl implements UsersService {
	...
	public List<Roles> getById2(Integer id) {
		Users byId2 = usersDao.getById2(id);
		List<Roles> role = new ArrayList<Roles>();
		List<UsersRoles> usersRoles = byId2.getUsersRoles();
		for (UsersRoles usersRoles2 : usersRoles) {
			Roles roles2 = usersRoles2.getRoles();
			role.add(roles2);
		}
		return role;
	}
	...
	public int addUser(Users users) {
		...
		;
		System.err.println(usersRoles.getRoles().getId() + "  " + usersRoles.getUsers().getId());
	...
	public void del2(Integer userId, Integer roleId) {
		usersRolesDao.deleteByUserIdRoleId(userId, roleId);
	...
	public String faceAdd(String image, Integer id, HttpServletRequest request) {
		...
		options.put("user_info", users.getName());
