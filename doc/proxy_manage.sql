...
CREATE TABLE `advisory_teacher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='咨询老师表';

-- ----------------------------
-- Records of advisory_teacher
-- ----------------------------
INSERT INTO `advisory_teacher` VALUES ('1', '李敏', '女');
INSERT INTO `advisory_teacher` VALUES ('2', '老周', '女');
INSERT INTO `advisory_teacher` VALUES ('3', '老刘', '男');
...
INSERT INTO `area` VALUES ('341402', '居巢区', '340100');
...
CREATE TABLE `attence` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` char(28) NOT NULL COMMENT '钉钉id',
...
-- ----------------------------
INSERT INTO `classroom` VALUES ('1', 'JAVA_1班', '2018-10-02', null);
INSERT INTO `classroom` VALUES ('2', 'HTML5班', '2018-10-03', null);
INSERT INTO `classroom` VALUES ('3', 'JAVA_3班', '2018-11-07', null);
...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES ('1', 'JAVA基础', '1', 'javac');
INSERT INTO `course` VALUES ('2', 'HTML5', '1', 'html5');
INSERT INTO `course` VALUES ('3', 'MYSQL', '1', 'mysql');
INSERT INTO `course` VALUES ('4', 'JSP', '1', 'jsp');
INSERT INTO `course` VALUES ('5', '实训', '1', 'shixun');
INSERT INTO `course` VALUES ('6', '框架', '1', 'kuang');
INSERT INTO `course` VALUES ('7', 'HTML5', '2', 'html5');
INSERT INTO `course` VALUES ('8', 'UI', '3', 'ui');
...
CREATE TABLE `education` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='学历表';

-- ----------------------------
-- Records of education
-- ----------------------------
INSERT INTO `education` VALUES ('1', '大学本科');
INSERT INTO `education` VALUES ('2', '大学专科');
...
CREATE TABLE `emergency_person` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='紧急联系人';

-- ----------------------------
-- Records of emergency_person
-- ----------------------------
INSERT INTO `emergency_person` VALUES ('1', '小红红', '15930906645', '1', '母女');
INSERT INTO `emergency_person` VALUES ('2', '小明明', '13223242134', '2', '父子');
INSERT INTO `emergency_person` VALUES ('8', '222', '222', '10', '222');
INSERT INTO `emergency_person` VALUES ('9', '123', '123', '11', '123');
INSERT INTO `emergency_person` VALUES ('10', '111111111111111111', '111111111111111111', '12', '111111111111111111');
INSERT INTO `emergency_person` VALUES ('11', '111111111111111111', '111111111111111111', '13', '111111111111111111');
INSERT INTO `emergency_person` VALUES ('12', '111111111111111111', '111111111111111111', '14', '111111111111111111');
INSERT INTO `emergency_person` VALUES ('13', '111111111111111111', '111111111111111111', '15', '111111111111111111');
INSERT INTO `emergency_person` VALUES ('14', '111', '123', '16', '123');
INSERT INTO `emergency_person` VALUES ('15', 'dada', '1008611', '3', '父子');
INSERT INTO `emergency_person` VALUES ('16', '111111111111111111', '111111111111111111', '17', '111111111111111111');
...
-- Records of exam
-- ----------------------------
INSERT INTO `exam` VALUES ('9', '1', '2018-01-11', '一月大考', '1', '1');
INSERT INTO `exam` VALUES ('10', '2', '2018-01-11', '一月大考', '2', '2');
INSERT INTO `exam` VALUES ('11', '3', '2018-01-11', '一月大考', '1', '3');
INSERT INTO `exam` VALUES ('12', '16', '2018-01-11', '一月大考', '2', '16');
INSERT INTO `exam` VALUES ('13', '4', '2018-01-11', '一月大考', '3', '4');
INSERT INTO `exam` VALUES ('14', '1', '2018-03-01', '三月大考', '1', '1');
...
CREATE TABLE `exam_name` (
  ...
  `date` date NOT NULL,
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考试名表';

-- ----------------------------
-- Records of exam_name
-- ----------------------------
INSERT INTO `exam_name` VALUES ('一月大考', null, '2018-01-11');
INSERT INTO `exam_name` VALUES ('三月大考', null, '2018-03-01');
INSERT INTO `exam_name` VALUES ('二月大考', null, '2018-02-01');
INSERT INTO `exam_name` VALUES ('四月大考', null, '2018-04-01');
...
CREATE TABLE `fee` (
  ...
  `payment_method_id` int(11) NOT NULL COMMENT '缴费方式ID',
  `fee_due_time_id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='缴费记录表';

-- ----------------------------
-- Records of fee
-- ----------------------------
INSERT INTO `fee` VALUES ('6', '学费', '10000', '2018-11-01 17:36:44', '1', '1', '1');
INSERT INTO `fee` VALUES ('7', '学费', '12000', '2018-11-01 00:00:00', '1', '1', '4');
INSERT INTO `fee` VALUES ('8', '学费', '10000', '2018-11-01 00:00:00', '1', '1', '16');
INSERT INTO `fee` VALUES ('9', '学费', '10000', '2018-11-13 21:49:01', '1', '1', '2');
INSERT INTO `fee` VALUES ('10', '学费', '1200', '2018-11-09 21:49:28', '1', '1', '3');
...
CREATE TABLE `fee_due_time` (
  ...
  `ent_date` date NOT NULL COMMENT '费用到期时间',
  `last_payment_time` date NOT NULL COMMENT '最后一次缴费时间',
  `student_id` int(11) NOT NULL,
  `continue_pay` varchar(255) NOT NULL COMMENT '是否需要继续缴费0:否1：是',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='费用到期时间';

-- ----------------------------
-- Records of fee_due_time
-- ----------------------------
INSERT INTO `fee_due_time` VALUES ('1', '学费', '2018-11-07', '2018-11-29', '1', '1');
INSERT INTO `fee_due_time` VALUES ('2', '杂费', '2018-11-07', '2018-11-07', '1', '0');
INSERT INTO `fee_due_time` VALUES ('3', '住宿费', '2018-11-07', '2018-11-07', '1', '1');
...
CREATE TABLE `original_major` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='原专业表';

-- ----------------------------
-- Records of original_major
-- ----------------------------
INSERT INTO `original_major` VALUES ('1', '电焊');
INSERT INTO `original_major` VALUES ('2', '厨师');
INSERT INTO `original_major` VALUES ('3', '挖掘机');
INSERT INTO `original_major` VALUES ('4', '计算机');
...
-- Records of payment
-- ----------------------------
INSERT INTO `payment` VALUES ('1', '贷款');
INSERT INTO `payment` VALUES ('2', '现金');
INSERT INTO `payment` VALUES ('3', '刷卡');
INSERT INTO `payment` VALUES ('4', '微信');
INSERT INTO `payment` VALUES ('5', '支付宝');
...
CREATE TABLE `proxyteacher_commission_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='招生老师历史提成表';

-- ----------------------------
-- Records of proxyteacher_commission_history
-- ----------------------------
INSERT INTO `proxyteacher_commission_history` VALUES ('7', '3', '小王八', '1', '小红', '10000', '20', '2000', '2018-11-01', null);
INSERT INTO `proxyteacher_commission_history` VALUES ('8', '2', '小王', '1', '小红', '10000', '5', '500', '2018-11-01', null);
INSERT INTO `proxyteacher_commission_history` VALUES ('9', '1', '老王', '1', '小红', '10000', '5', '500', '2018-11-01', null);
INSERT INTO `proxyteacher_commission_history` VALUES ('10', '3', '小王八', '1', '小红', '8000', '20', '1600', '2018-11-01', null);
INSERT INTO `proxyteacher_commission_history` VALUES ('11', '2', '小王', '1', '小红', '8000', '5', '400', '2018-11-01', null);
INSERT INTO `proxyteacher_commission_history` VALUES ('12', '1', '老王', '1', '小红', '8000', '5', '400', '2018-11-01', null);
...
CREATE TABLE `proxyteacher_month` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='招生老师月结算';

-- ----------------------------
-- Records of proxyteacher_month
-- ----------------------------
INSERT INTO `proxyteacher_month` VALUES ('16', '1', '老王', '30', '950', '2018-11-01', '手动阀', '0');
INSERT INTO `proxyteacher_month` VALUES ('17', '2', '小王', '25', '950', '2018-11-01', '范德萨', '0');
INSERT INTO `proxyteacher_month` VALUES ('18', '3', '小王八', '20', '3800', '2018-11-01', '范德萨发', '0');
INSERT INTO `proxyteacher_month` VALUES ('19', '1', '老王', '30', '950', '2018-11-01', 'dsafds', '0');
INSERT INTO `proxyteacher_month` VALUES ('20', '2', '小王', '25', '950', '2018-11-01', 'fdas', '0');
INSERT INTO `proxyteacher_month` VALUES ('21', '3', '小王八', '20', '3800', '2018-11-01', 'dsa', '0');
INSERT INTO `proxyteacher_month` VALUES ('22', '1', '老王', '30', '950', '2018-11-01', '老王', '1');
INSERT INTO `proxyteacher_month` VALUES ('23', '2', '小王', '25', '950', '2018-11-01', '小王', '1');
INSERT INTO `proxyteacher_month` VALUES ('24', '1', '老王', '30', '950', '2018-11-01', '老王工资', '1');
INSERT INTO `proxyteacher_month` VALUES ('25', '1', '老王', '30', '950', '2018-11-01', '123', '0');
INSERT INTO `proxyteacher_month` VALUES ('26', '2', '小王', '25', '950', '2018-11-01', 'qwe', '0');
INSERT INTO `proxyteacher_month` VALUES ('27', '3', '小王八', '20', '3800', '2018-11-01', '1231231', '0');
INSERT INTO `proxyteacher_month` VALUES ('28', '2', '小王', '25', '950', '2018-11-01', null, '0');
INSERT INTO `proxyteacher_month` VALUES ('29', '3', '小王八', '20', '3800', '2018-11-01', null, '0');
...
CREATE TABLE `proxy_teacher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='招生老师信息表';

-- ----------------------------
-- Records of proxy_teacher
-- ----------------------------
INSERT INTO `proxy_teacher` VALUES ('1', '老王', '男', '142724198811263123', '31', '13838381438', '13838381438', '123456', null, '山西', '2018-10-19 19:15:22', '', '1', '1', '30', null, '', '', '', '', '1');
INSERT INTO `proxy_teacher` VALUES ('2', '小王', '男', '142724196603052145', '48', '13838385438', '13838385438', '654321', null, '--', '2018-10-19 19:20:17', '阿斯蒂芬', '1', '2', '25', '1', '12345', '12345', '234567', '123', '0');
INSERT INTO `proxy_teacher` VALUES ('3', '小王八', '男', '142724200010102525', '18', '13825813697', '13825813697', '258369', null, '山西', '2018-10-20 09:24:05', null, null, '3', '20', '2', null, null, null, null, '1');
INSERT INTO `proxy_teacher` VALUES ('4', '老邓', '男', '142724186502057856', '53', '13225888522', '13225888522', '123456', null, '山西', '2018-10-20 11:38:30', null, null, '2', '25', '1', null, null, null, null, '1');
INSERT INTO `proxy_teacher` VALUES ('6', '小八', '男', '142724198605091256', '51', '13133140258', '13133140258', '36987', null, '河南', '2018-10-22 09:13:43', null, null, '5', '10', '5', null, null, null, null, '1');
INSERT INTO `proxy_teacher` VALUES ('7', '小九', '男', '142724198605091257', '51', '13133140258', '13133140258', '36987', null, '河南', '2018-10-22 09:13:43', null, null, '1', '30', null, null, null, null, null, '0');
INSERT INTO `proxy_teacher` VALUES ('8', '小史', '男', '142622199909091121', '19', '123456789', '123456', '123456', null, '山西省-阳泉市-平定县', '2018-09-07 21:10:34', '方达', '1', '6', '12.0', '4', null, null, null, null, '0');
INSERT INTO `proxy_teacher` VALUES ('9', '范德萨', '男', '142622199902021122', '19', '123456', '123456', '123456', null, '山东省-济南市-平阴县', '2018-11-01 21:35:37', null, '是', '2', '25.0', '2', null, null, null, null, '0');
INSERT INTO `proxy_teacher` VALUES ('15', 'dded', '男', '140828199805020036', '20', '12222', '123', '12', null, '湖北省-武汉市-新洲区', '2018-11-06 14:26:55', 'ww', '是', '1', '1222.0', '5', '23', '23', '123', '23', '0');
INSERT INTO `proxy_teacher` VALUES ('16', 'hh', '男', '140828198805023306', '30', '123', '123', '123', null, '河南省-漯河市-召陵区', '2018-11-29 14:34:10', '23', '1', '3', '2.0', '2', '23', '123', '23', '234', '0');
INSERT INTO `proxy_teacher` VALUES ('17', '123444', '男', '140828', '29', '234', '1234', '234', null, '河南省-枣庄市-滕州市', '2018-11-06 14:45:48', '234', '1', '4', '2.0', '4', '123', '1234', '123', '123', '0');
INSERT INTO `proxy_teacher` VALUES ('18', 'sdfsdff', '男', '140828198504060014', '33', '1234', null, '234', null, '浙江省-杭州市-市辖区', '2018-12-05 15:34:30', '234', '1', '3', '12.0', '3', '2345', '234', '23', '234', '0');
INSERT INTO `proxy_teacher` VALUES ('20', 'fdsa', '男', '142622198811110212', '29', '123123', '123', '123123', null, '湖南省-长沙市-市辖区', '2018-11-01 15:49:24', null, '是', '1', '23.0', null, '123', '123', '123', '123', '0');
INSERT INTO `proxy_teacher` VALUES ('21', 'www', '男', '140828196804060025', '50', '123', '23', '123', null, '广东省-广州市-从化市', '2018-11-21 16:13:04', '23', '是', '3', '2.0', '3', '23', '23', '1234', '123', '0');
INSERT INTO `proxy_teacher` VALUES ('22', 'www', '男', '140828198706030036', '31', '123', '123', '123', null, '辽宁省-沈阳市-康平县', '2018-11-06 16:14:35', 'qw3', '是', '3', '12.0', '4', '123', '123', '12', '123', '0');
INSERT INTO `proxy_teacher` VALUES ('23', 'SWS', '男', '140828195806030058', '60', '123', '23', '123', null, '辽宁省-沈阳市-市辖区', '2018-11-21 16:15:45', '23', '是', '3', '11.0', '3', '123', '23', '12', '123', '0');
INSERT INTO `proxy_teacher` VALUES ('25', '113', '男', '123123123112121234', '786', '123', '123', '123', 'pics/bn/1501061614211+1555311072.jpg', '黑龙江省-哈尔滨市-市辖区', '2018-11-06 17:50:30', '123', '是', '1', '123.0', '2', '123', '123', '123', '123', '0');
INSERT INTO `proxy_teacher` VALUES ('26', '122', '男', '140828199805020036', '20', '123', '123', '1234', 'pics/bn/1501061614211+1555311072.jpg', '河南省-郑州市-金水区', '2018-11-27 09:58:06', '123', '1', '4', '1.0', '3', '123', '23', '123', '1234', '0');
INSERT INTO `proxy_teacher` VALUES ('27', '123', '男', '140828199805020036', '20', '123', '123', '1234', 'pics/bn/1501061614211+1555311072.jpg', '广东省-广州市-市辖区', '2018-11-21 10:01:07', '234', '是', '3', '2.0', '3', '234', '234', '234', '234', '0');
...
CREATE TABLE `rank` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='招生老师级别表';

-- ----------------------------
-- Records of rank
-- ----------------------------
INSERT INTO `rank` VALUES ('1', '副总裁');
INSERT INTO `rank` VALUES ('2', '大总监');
INSERT INTO `rank` VALUES ('3', '总监');
INSERT INTO `rank` VALUES ('4', '副总监');
INSERT INTO `rank` VALUES ('5', '区域经理');
INSERT INTO `rank` VALUES ('6', '县办');
INSERT INTO `rank` VALUES ('7', '招办');
INSERT INTO `rank` VALUES ('8', '招生老师');
...
CREATE TABLE `score` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='分数表';

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES ('18', '9', '1', '99');
INSERT INTO `score` VALUES ('19', '9', '2', '77');
INSERT INTO `score` VALUES ('20', '9', '3', '88');
INSERT INTO `score` VALUES ('21', '9', '4', '86');
INSERT INTO `score` VALUES ('22', '9', '5', '45');
INSERT INTO `score` VALUES ('23', '9', '6', '33');
INSERT INTO `score` VALUES ('24', '10', '1', '45');
INSERT INTO `score` VALUES ('25', '10', '2', '45');
INSERT INTO `score` VALUES ('26', '10', '3', '54');
INSERT INTO `score` VALUES ('27', '10', '4', '100');
INSERT INTO `score` VALUES ('28', '10', '5', '87');
INSERT INTO `score` VALUES ('29', '10', '6', '99');
INSERT INTO `score` VALUES ('30', '11', '7', '100');
INSERT INTO `score` VALUES ('31', '12', '7', '87');
INSERT INTO `score` VALUES ('32', '13', '8', '50');
INSERT INTO `score` VALUES ('33', '14', '1', '100');
INSERT INTO `score` VALUES ('34', '14', '2', '55');
INSERT INTO `score` VALUES ('35', '14', '3', '66');
...
CREATE TABLE `student` (
  ...
  `tel` varchar(255) NOT NULL COMMENT '电话',
  `address` varchar(255) NOT NULL COMMENT '地址',
  `join_time` datetime NOT NULL COMMENT '入学时间',
  `education_id` int(11) DEFAULT NULL COMMENT '学历id',
  `degree` varchar(255) DEFAULT NULL COMMENT '学位',
  `original_major` varchar(11) DEFAULT NULL COMMENT '原专业id',
  ...
  `idcard_pic` varchar(255) DEFAULT NULL COMMENT '身份证图片',
  `simulation_classroom_id` int(11) DEFAULT NULL COMMENT '模拟班级id',
  `before_address` varchar(255) NOT NULL COMMENT '出发地',
  `transportation_id` int(11) NOT NULL COMMENT '出行方式',
  `incidentals` decimal(10,0) DEFAULT NULL COMMENT '杂费',
  `quarterage` decimal(10,0) DEFAULT NULL COMMENT '住宿费',
  `ding_id` char(18) DEFAULT NULL COMMENT '钉钉用户Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='学生基本信息表';

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('1', '小红', '女', '14272420001234', '18', '2000-03-05 00:00:00', '13811002200', '北京市-东城区-市辖区', '2018-07-01 19:23:43', '3', null, '1', null, '1', '1', '3180', '15000', '1', '1', '1', '3', null, null, null, '山西', '1', '10000', '20000', null);
INSERT INTO `student` VALUES ('2', '小明', '男', '142724200010102541', '15', '2000-10-10 00:00:00', '13814783698', '北京市-东城区-市辖区', '2018-07-01 09:41:47', '3', null, '1', null, '1', '1', '3180', '10000', '2', '1', '1', '4', null, null, null, '山西', '1', '10000', '20000', null);
INSERT INTO `student` VALUES ('3', '大王', '男', '142724200003052456', '18', '2000-03-05 00:00:00', '13133140258', '北京市-东城区-市辖区', '2018-07-01 17:48:35', '3', null, '1', null, '1', '2', '3180', '10000', '1', '2', '1', '2', null, null, null, '山西', '1', null, null, null);
INSERT INTO `student` VALUES ('4', '小李', '男', '123444', '20', '2000-02-09 00:00:00', '12343', '北京市-东城区-市辖区', '2018-10-10 08:10:08', '3', null, '1', null, '1', '3', '3180', '15000', '3', '3', '1', '3', null, null, null, '山西', '1', null, null, null);
INSERT INTO `student` VALUES ('16', '高壮壮', '男', '111111111111111111', '22', '1111-11-11 00:00:00', '111111111111111111', '安徽省-合肥市-市辖区', '2018-11-08 00:00:00', '2', null, null, null, '1', '2', '35800', null, '2', '1', '2', '2', null, 'pics/student/tomcat.png', null, '123', '6', '11800', '5500', null);
...
CREATE TABLE `student_auditing` (
  ...
  `student_id` int(11) NOT NULL COMMENT '学生id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='审核表';

-- ----------------------------
-- Records of student_auditing
-- ----------------------------
INSERT INTO `student_auditing` VALUES ('9', '花花', '2018-11-01 00:00:00', '2', '审核通过', '4');
INSERT INTO `student_auditing` VALUES ('10', '哗', '2018-11-02 00:00:00', '1', 'la', '1');
INSERT INTO `student_auditing` VALUES ('11', 'hau', '2018-11-02 00:00:00', '4', '作废', '3');
INSERT INTO `student_auditing` VALUES ('12', 'z', '2018-11-15 21:49:43', '4', null, '2');
INSERT INTO `student_auditing` VALUES ('13', '小黑', '2018-11-01 00:00:00', '2', '审核通过', '1');
INSERT INTO `student_auditing` VALUES ('14', '小黑', '2018-11-01 00:00:00', '1', '审核不通过', '2');
INSERT INTO `student_auditing` VALUES ('15', '小黑', '2018-11-01 00:00:00', '2', '审核通过', '3');
INSERT INTO `student_auditing` VALUES ('16', '小黑', '2018-11-01 00:00:00', '1', '审核不通过', '4');
INSERT INTO `student_auditing` VALUES ('17', '小黑', '2018-11-01 00:00:00', '4', '作废', '1');
INSERT INTO `student_auditing` VALUES ('18', '小黑', '2018-11-01 00:00:00', '3', '已报销', '3');
INSERT INTO `student_auditing` VALUES ('19', '小黑', '2018-11-01 00:00:00', '2', '通过', '2');
INSERT INTO `student_auditing` VALUES ('20', '小黑', '2018-11-01 00:00:00', '3', '确认报销', '2');
INSERT INTO `student_auditing` VALUES ('21', '深度', '2018-11-23 15:34:49', '3', '大豆粉', '16');
...
CREATE TABLE `student_reimbursement` (
  ...
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`7`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='学生报销';

-- ----------------------------
-- Records of student_reimbursement
-- ----------------------------
INSERT INTO `student_reimbursement` VALUES ('1', '1', 'wwqewq', '1231233', '100', '10', '324324', '4', 'sdrwr');
INSERT INTO `student_reimbursement` VALUES ('2', '2', 'sdfsdf', '123123', '100', '10', '23132131', '0', '2313');
INSERT INTO `student_reimbursement` VALUES ('10', '3', 'dade', '10086', '100', '10', '123', '0', null);
INSERT INTO `student_reimbursement` VALUES ('11', '4', '到十点', '1232321', '11111', '11111', '123', '0', '0');
INSERT INTO `student_reimbursement` VALUES ('12', '16', 'dadf', '1008620', '100', '10', '123', '1', '0');
...
CREATE TABLE `study_time` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='学习时长';

-- ----------------------------
-- Records of study_time
-- ----------------------------
INSERT INTO `study_time` VALUES ('1', '10');
INSERT INTO `study_time` VALUES ('2', '12');
INSERT INTO `study_time` VALUES ('3', '18');
INSERT INTO `study_time` VALUES ('4', '24');
...
CREATE TABLE `teacher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='老师表';

-- ----------------------------
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES ('1', '老刘', '1');
INSERT INTO `teacher` VALUES ('2', '老胡', '1');
INSERT INTO `teacher` VALUES ('3', '老陈', '1');
INSERT INTO `teacher` VALUES ('22', '老邱', '2');
...
CREATE TABLE `teacher_auditing` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='审核表';

-- ----------------------------
-- Records of teacher_auditing
-- ----------------------------
INSERT INTO `teacher_auditing` VALUES ('3', 'fds', '2018-11-09 21:38:58', '3', null, '1');
...
-- ----------------------------
INSERT INTO `teacher_classroom` VALUES ('1', '1', '2018-10-10', null);
INSERT INTO `teacher_classroom` VALUES ('1', '2', '2018-10-25', null);
INSERT INTO `teacher_classroom` VALUES ('1', '3', '2018-10-17', null);
INSERT INTO `teacher_classroom` VALUES ('2', '1', '2018-10-03', null);
INSERT INTO `teacher_classroom` VALUES ('2', '3', '2018-10-10', null);
INSERT INTO `teacher_classroom` VALUES ('21', '3', '2018-11-07', null);
...
CREATE TABLE `transportation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='交通方式';

-- ----------------------------
-- Records of transportation
-- ----------------------------
INSERT INTO `transportation` VALUES ('1', '客车');
INSERT INTO `transportation` VALUES ('2', '动车');
INSERT INTO `transportation` VALUES ('3', '自驾');
INSERT INTO `transportation` VALUES ('4', '学校大巴');
INSERT INTO `transportation` VALUES ('5', '火车硬座');
INSERT INTO `transportation` VALUES ('6', '火车硬卧');
INSERT INTO `transportation` VALUES ('7', '高铁二等座');
...
CREATE TABLE `tuition` (
  ...
  `quarterage` decimal(10,0) DEFAULT NULL COMMENT '住宿费',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='学费表';

-- ----------------------------
-- Records of tuition
-- ----------------------------
INSERT INTO `tuition` VALUES ('1', '1', '2', '35800', '11800', '5500');
INSERT INTO `tuition` VALUES ('2', '2', '3', '46800', '10000', '5000');
INSERT INTO `tuition` VALUES ('3', '3', '2', '51800', '5500', '10000');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'admin', '女', 'e10adc3949ba59abbe56e057f20f883e', '16681235481', '2865127@.com');
...
CREATE TABLE `visit_fee` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='招生老师来访费用';

-- ----------------------------
-- Records of visit_fee
-- ----------------------------
INSERT INTO `visit_fee` VALUES ('1', '1', '1', '1000', '500', '200');
...
CREATE TABLE `visit_records` (
  ...
  `reimbursement_voucher` varchar(0) NOT NULL COMMENT '招生老师报销凭证',
  `reimbursement_amount` decimal(10,0) NOT NULL COMMENT '需报销总钱数',
  `payment_id` int(11) NOT NULL COMMENT '支付方式id',
  `reimbursement_time` datetime NOT NULL COMMENT '报销时间',
  `bank_name` varchar(255) DEFAULT NULL COMMENT '银行卡姓名',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='招生老师来访记录';

-- ----------------------------
-- Records of visit_records
-- ----------------------------
INSERT INTO `visit_records` VALUES ('00000000001', '山西', '送生', '2018-11-01 15:27:43', '', '100', '1', '2018-11-01 15:29:04', '大萨达', '123456', '邮政', '1', '3');
