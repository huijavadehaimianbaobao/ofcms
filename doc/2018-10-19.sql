...
CREATE TABLE `fee_due_time` (
  ...
  `ent_date` datetime NOT NULL COMMENT '费用到期时间',
  `last_payment_time` datetime NOT NULL COMMENT '最后一次缴费时间',
  `student_id` int(11) NOT NULL,
...
CREATE TABLE `proxyteacher_month` (
  ...
  `commission_point` double NOT NULL COMMENT '提成点位',
  `commission_amount` decimal(10,0) NOT NULL COMMENT '提成金额',
  `commission_date` date NOT NULL COMMENT '结算日期',
...
CREATE TABLE `proxy_teacher` (
  ...
  `parent_proxy_teacher_id` int(11) NOT NULL COMMENT '上级人id',
...
CREATE TABLE `student` (
  ...
  `original_major_id` int(11) NOT NULL COMMENT '原专业id',
  ...
  `unpai_tuition` decimal(10,0) NOT NULL COMMENT '未缴学费',
  `classroom_id` int(11) NOT NULL COMMENT '班级id',
...
CREATE TABLE `student_reimbursement` (
  ...
  `bill_amount` decimal(10,0) NOT NULL COMMENT '票据金额',
  `amount_reported` decimal(10,0) NOT NULL COMMENT '应报金额',
  `ticket_voucher` varchar(255) NOT NULL COMMENT '车票凭证',
...
CREATE TABLE `study_time` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `study_time` datetime NOT NULL COMMENT '学习时长',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `teacher_classroom` (
  ...
  `over_time` date NOT NULL COMMENT '老师离班时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `visit_records` (
  ...
  `reimbursement_voucher` varchar(255) NOT NULL COMMENT '招生老师报销凭证',
